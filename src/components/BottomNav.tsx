...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 w-full bg-card/95 backdrop-blur-md border-t border-border/60 z-50" style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }}>
