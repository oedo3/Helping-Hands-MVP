...
export function TopBar() {
  ...
  return (
    <>
      <header className="hidden md:flex items-center justify-between px-8 py-4 sticky top-0 z-40 bg-card/95 backdrop-blur-lg border-b border-border/60 shadow-[0_1px_8px_rgba(15,23,42,0.04)]">
